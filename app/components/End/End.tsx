  ...
  return (
    <div className="w-full h-full p-5 flex flex-col items-center gap-5">
      ...
      <div className="relative flex flex-col items-center">
        <CallSVG
          className="bg-size-[200%_200%] z-10 bg-linear-to-r from-[#00C9B5] to-[#14C900] hover:animate-gradient-flow rounded-full p-4 shadow-lg"
          width={80}
          height={80}
          fill="white"
        />
        <div className="absolute w-5 h-5 bg-green-500 z-20 border-4 border-gray-800 rounded-full right-5 bottom-12" />
      ...
      <div className="w-full h-full overflow-y-auto custom-scrollbar flex flex-col gap-3">
        {messages.map((message, index) => (
          <div key={index} className="w-full flex flex-col px-3">
